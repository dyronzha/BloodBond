...
namespace BloodBond {
    public class EnemyNightmare : EnemyBase
    {
        ...
        {
            //return false;
            if (PlayerInDistance(enemyManager.NightmareValue.SightDistance))
            {
                Debug.Log("馴鹿空檔idle");
                if (distanceCase == 2)
                {
        ...
        public override void InHurt()
        {
            ...
            else
            {
                ...
                bool canSee = PlayerInDistance(enemyManager.NightmareValue.SightDistance);
